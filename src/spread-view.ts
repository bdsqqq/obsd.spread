import { BasesView, QueryController, ViewOption, TFile, App } from "obsidian";
...
const SPREAD_VIEW_TYPE = "spread-view";
...
export class SpreadView extends BasesView {
  ...
  private async render(): Promise<void> {
    ...
    // step D: init virtualizer with scrollEl
    this.setupVirtualizer(this.scrollEl, this.rows);
